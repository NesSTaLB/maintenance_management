    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('air_conditioner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.airconditioner')),
                ('assigned_to', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.technician')),
            ],
        ),
        migrations.AddField(
